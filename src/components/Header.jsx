  ...
  return (
    <header className="flex justify-between items-center p-4">
      ...
      >
        <input
          type="text"
          className="bg-black outline-none rounded-[20px] px-3 py-1 w-[600px] h-10 max-sm:w-auto max-md:w-auto max-lg:p-3"
          placeholder="Search"
        />
      ...
      <div className="flex gap-3 text-xl cursor-pointer">
        <AiFillBell className="max-sm:hidden hover:text-gray-400" />
        <AiFillVideoCamera className="max-sm:hidden hover:text-gray-400" />
      </div>
    </header>
  );
};
